...
public class Main {
    ...
    */
    ...
    public static void mergesort(Musica[] array, int esq, int dir) {
        if (esq < dir){
            countComp++;
            int meio = (esq + dir) / 2;
    ...
    public static void intercalar(Musica[] array, int esq, int meio, int dir){
        int n1, n2, i, j, k;
        ...
        a1[i] = new Musica();
        a1[i].setEnergy(500000.0);
        a2[j] = new Musica();
        a2[j].setEnergy(5000000.0);
    ...
    public static void compareEnergy(Musica[] array){
        //Musica[] resp = new Musica[array.length];
        for(int i = 0; i < array.length-1; i++){
            int menor = i;
            for (int j = i; j <= array.length-1 && (array[j].getEnergy() == array[i].getEnergy()); j++) {
