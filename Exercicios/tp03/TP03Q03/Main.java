...
class FilaCircular {
     ...
     */
    public boolean enfileira(Musica item) {
    ...
    public Object desenfileira() {
       ...
       if (frente == tras)
         ...
         return array[frente++% array.length];
    }
    ...
    */    
    public void mostrar(){
        ...
        for(int i = frente; i < tras; i++)
            media += array[i % array.length].getDuration();
        
        media = media/(tras-frente);
...
public class Main {
    ...
    */
    public static void processComand(String s, FilaCircular MusicaFilo, Musica[] bd){
        String [] val = s.split(" ");
        Object holder = null;
        Musica aux = new Musica();
        switch(val[0]){
            case "R":
                holder = MusicaFilo.desenfileira();
                if(holder != null){
                    aux = (Musica) holder;
    ...
    public static void main(String[] args) throws Exception{
        ...
        FilaCircular MusicaFila = new FilaCircular(5);
        int i = 0;
        ...
        i = 0;
        while (!isFim(val[i])){
            MusicaFila.enfileira(lookForMusica(val[i], entrada));
            i++;
        }

        i = Integer.valueOf(MyIO.readLine());
        for(int j = 0; j <i; j++){
            processComand( MyIO.readLine(), MusicaFila, entrada);
        }
        br.close();
    }
